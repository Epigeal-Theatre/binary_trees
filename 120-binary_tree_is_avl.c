 ...
 *
 * Return: 1 if tree is avl. or otherwise 0 otherwise
 */
...
/**
 * btia_helper - helperfunction to check if a binary tree is an avl.
 *
 * @tree: ptr to the root node of the tree.
 *
 * @min: minimum value.
 ...
 * @max: maximum value.
 *
 * Return: 1 if tree is avl or otherwise 0
 */
 ...
 *
 * Return: height of the tree otherwise return 0 if tree is NULL
 */
